...
### How do I remove React Router?
 ...
 2. Remove `import { Switch, NavLink, Route } from 'react-router-dom';` from top of `src/components/App.js`, add a reference to `src/components/UserSalving.js`, and replace body of (implicit) render with this: `<FuelSavingsPage />`.
